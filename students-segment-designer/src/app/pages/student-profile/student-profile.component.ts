...
@Component({
  ...
  standalone: true,
  imports: [
    GenericLoadingComponent, CommonModule, MatCardModule, MatIconModule, MatButtonModule
  ],
...
export class StudentProfileComponent implements OnInit, OnDestroy {
  ...
  constructor(private route: ActivatedRoute, private store: Store, private matDialog: MatDialog) {
  }
